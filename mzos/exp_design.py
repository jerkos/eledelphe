...
class ExperimentalSettings(object):
    ...
    def __init__(self, mz_tol_ppm, adducts, ionisation_mode=None, is_dims_experiment=False, databases={'hmdb'}):
        self.samples = set()
    ...
    def get_mass_to_check(self):
        ...
        :return:
        """
        f = [l.split(",") for l in self.adducts]
        return [((float(l[3]), 1), l[0]) for l in f]
        # if self.is_dims_exp:
